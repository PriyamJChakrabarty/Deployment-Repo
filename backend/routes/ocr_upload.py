...
def generate_structured_content(prompt: str, schema: BaseModel) -> Union[str, Dict]:
    """
    Sends a prompt to Groq and forces the response into structured JSON defined by the Pydantic schema.
    Returns a JSON string of the structured data, or a dict containing an error message.
    """
    try:
